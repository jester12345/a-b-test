...
var ABTest = function () {
    ...
    function ABTest() {
        ...
        var button = document.getElementById('price_button');
    ...
    _createClass(ABTest, [{
        ...
        key: 'setupFormErrorMessages',
        value: function setupFormErrorMessages() {
            /**
            ...
            var required = void 0,
                ...
                id = void 0,
                elem = void 0;
            for (var me in this.modalForm.elements) {
        ...
        value: function modalImage() {
            ...
            if (imgSrc) {
                var priceQuoteImg = document.getElementById('price_quote_image');
        ...
        value: function modalCloseButton() {
        ...
        key: 'setStateOptions',
        value: function setStateOptions() {
        ...
        key: 'customInputEvent',
        value: function customInputEvent() {
        ...
        key: 'submitPriceForm',
        value: function submitPriceForm(e) {
            e.preventDefault();
